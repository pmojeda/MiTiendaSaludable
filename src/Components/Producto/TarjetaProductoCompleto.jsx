...
export default function TarjetaProductoCompleto({ id, imagen, nombre, descripcion, precio, stock }) {
  ...
  return (
    <div className="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-md h-full mx-3 my-3">
      <img
        src={imagen}
        alt={nombre}
      ...
      <div className="p-1">        
        <h3 className="mb-2 text-1xl font-bold text-gray-800">
          {nombre}
        </h3>
        ...
        <button className="w-100 rounded-xl bg-black px-4 py-1 text-sm font-semibold text-white transition-colors duration-300 hover:bg-gray-800" onClick={agregarAlCarrito}>
          Agregar al carrito
        </button>
      </div>
    </div>
